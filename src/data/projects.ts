...
const projects: Project[] = [
    new Project(
        ...
        'A static website displaying birds native to Aotearoa. Currently a Front-end application with the back-end still in development.',
    ...
    new Project(
        ...
        undefined,
        'https://github.com/davebroc/Blackjack-Trainer'
    ),
    new Project(
        'GotoGrow PWA',
        './gotogrow.JPG',
